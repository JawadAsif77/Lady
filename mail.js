const firebaseConfig = {
    apiKey: "AIzaSyDUyUFCtZUWRGzVainuARzGN0vnuZlEZtc",
    authDomain: "lady-fe27b.firebaseapp.com",
    databaseURL: "https://lady-fe27b-default-rtdb.firebaseio.com",
    projectId: "lady-fe27b",
    storageBucket: "lady-fe27b.appspot.com",
    messagingSenderId: "186192170132",
    appId: "1:186192170132:web:ebd857fdd9e02338523881"
  };
  ...
  button.addEventListener("click", () => {
    ...
    const userMessage = prompt("Write a message:");
...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Hey Precious Lady, everyday day I cannot believe how lucky I am",
      canvas.width / 2,
      canvas.height / 2
    );
